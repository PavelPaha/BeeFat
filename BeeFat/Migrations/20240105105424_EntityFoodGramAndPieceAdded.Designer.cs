...
namespace BeeFat.Migrations
{
    ...
    [Migration("20240105105424_EntityFoodGramAndPieceAdded")]
    partial class EntityFoodGramAndPieceAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeeFat.Domain.Infrastructure.FoodGram", b =>
                {
                    b.HasBaseType("BeeFat.Domain.Infrastructure.Food");

                    b.HasDiscriminator().HasValue("FoodGram");
                });

            modelBuilder.Entity("BeeFat.Domain.Infrastructure.FoodPiece", b =>
                {
                    b.HasBaseType("BeeFat.Domain.Infrastructure.Food");

                    b.HasDiscriminator().HasValue("FoodPiece");
                });
